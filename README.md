...
- **84 topics** across 8 categories: quick assessment, life-saving skills, trauma & wound care, medical & environmental emergencies, disaster & security response, wilderness & outdoor skills, and everyday preparedness
...
- **Topic Connection Graph** — a visual map of how the 84 topics cluster into 8 main categories; tap any node to jump straight to that topic (falls back to a tap-friendly accordion list on phone-width screens)
...
| `全方位緊急應變小卡 (1).md` | The same 84 topics as a plain Markdown document. |
| `全方位緊急應變小卡_總覽地圖.png` | A one-page poster mapping all 84 topics by category (stale — last regenerated at 81 topics). |
